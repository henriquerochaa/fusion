...
class Funcionario(Base):
    ...
    image = StdImageField('Imagem', upload_to=get_file_path, variations={
...
class Caracteristica(Base):
    ICONE_CHOICES = (
        ('lni-rocket', 'Foguete'),
        ('lni-laptop-phone', 'Aparelho'),
        ('lni-cog', 'Engrenagem'),
        ('lni-leaf', 'Folha'),
        ('lni-layers', 'Design')
    )

    caracteristica = models.CharField('Caracteristica', max_length=100)
    descricao = models.TextField('Descrição', max_length=120)
